...
extern "C"
{
	...
	namespace indexdb
	{
		...
		JNIEXPORT jint JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_create(JNIEnv *, jclass, jint index, jboolean ignoreCase, jboolean compress,
				jbyteArray bytes)
		{
			rwlock.wrlock();
		...
		JNIEXPORT jint JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_destroy(JNIEnv *, jclass, jint index)
		{
			rwlock.wrlock();
			if (indexs->find(index) != indexs->end())
			{
		...
		JNIEXPORT jint JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_load(JNIEnv *env, jclass, jint index, jstring file)
		{
			rwlock.rdlock();
			if (indexs->find(index) != indexs->end())
			{
		...
		JNIEXPORT jint JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_dump(JNIEnv *env, jclass, jint index, jstring file)
		{
			rwlock.rdlock();
			if (indexs->find(index) != indexs->end())
			{
		...
		JNIEXPORT jint JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_addDoc(JNIEnv * env, jclass, jint index, jlong key, jlong sort, jobjectArray terms)
		{
			rwlock.rdlock();
			if (indexs->find(index) != indexs->end())
			{
		...
		JNIEXPORT jint JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_delDoc(JNIEnv * env, jclass, jint index, jlong key)
		{
			rwlock.rdlock();
			if (indexs->find(index) != indexs->end())
			{
		...
		JNIEXPORT jlongArray JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_queryByKeys(JNIEnv * env, jclass, jint index, jlongArray array)
		{
			rwlock.rdlock();
			if (indexs->find(index) != indexs->end())
			{
		...
		JNIEXPORT jlongArray JNICALL Java_org_jkuang_qstar_commons_jni_RIndex_query(JNIEnv * env, jclass, jint index, jstring jsyntax, jlong _s_sort_,
